...
export default class CKUploadAdapter extends Plugin{
    ...
    init() {
        ...
        this.editor.plugins.get( FileRepository ).createUploadAdapter = loader => new UploadAdapter( loader, url, formField );
    }
}

class UploadAdapter{
	constructor(loader, url, formField) {
	...
	_sendRequest() {
		...
		data.append(this.formField, this.loader.file);
